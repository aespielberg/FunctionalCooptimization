classdef NonlinearComplementarityConstraintTest2 < CompositeConstraint
  ...
  methods
    ...
    function obj = NonlinearComplementarityConstraintTest2(fun,xdim,zdim,paramdim, mode,slack)
      if nargin < 4
        mode = 1;
      end
      if nargin < 5
