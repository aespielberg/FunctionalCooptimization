function constraint = constructAboveGroundConstraintNoParams( lb, ub, plant, frame_name)
...
constraintHandle = matlabFunction(f, df, 'vars', {[q; qd]});
...
constraint = FunctionHandleConstraint(lb, ub, (plant.getNumOutputs()), constraintHandle);
end