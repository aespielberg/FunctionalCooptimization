function [p,xtraj,utraj,ltraj,ljltraj,z,F,info,traj_opt, midcost, midz, utraj_init]...
    = antTrajOpt(xtraj,utraj,ltraj,ljltraj,scale, costs, regularization_type,...
...
torque = 60;
p = p.setInputLimits(-torque * ones(ui, 1), torque * ones(ui, 1)); %the input torque limits
...
if isempty(xtraj)
    ...
    if first_gait
        traj_init.l = PPTrajectory(foh(t_init,[ ...
            repmat([zeros(6, 1); singleLeg; singleLeg; zeros(6, 1); singleLeg; zeros(6, 1);],1,N4) ...
            repmat([singleLeg; singleLeg; singleLeg; singleLeg; singleLeg; singleLeg],1,N4) ...
            repmat([singleLeg; zeros(6, 1); zeros(6, 1);  singleLeg; zeros(6, 1); singleLeg],1,N4) ...
            repmat([singleLeg; singleLeg; singleLeg; singleLeg; singleLeg; singleLeg],1,N4)]));
    else
